...
def validate_registries(registry_dir: Path, schema_dir: Path) -> RegistryValidationResult:
    ...
    file_handlers = {
        ...
        "pjm_fundamental_feeds.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "pjm_fundamental_feed.schema.json"), "pjm_fundamental_feeds", "feed_id"),
        "pjm_load_areas.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "pjm_load_area.schema.json"), "pjm_load_areas", "area_id"),
        "power_generation_fuels.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_generation_fuel.schema.json"), "power_generation_fuels", "fuel_id"),
        "power_generation_mix_feeds.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_generation_mix_feed.schema.json"), "power_generation_mix_feeds", "feed_id"),
        "power_market_calendars.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_market_calendar.schema.json"), "power_market_calendars", "calendar_id"),
        "power_system_artifact_products.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_artifact_product.schema.json"), "power_system_artifact_products", "artifact_key"),
        "power_system_artifact_retention_policies.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_artifact_retention_policy.schema.json"), "power_system_artifact_retention_policies", "artifact_key"),
        "power_system_operators.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_operator.schema.json"), "power_system_operators", "operator_id"),
        "power_system_operational_event_feeds.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_operational_event_feed.schema.json"), "power_system_operational_event_feeds", "feed_id"),
        "power_system_source_access_policies.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_source_access_policy.schema.json"), "power_system_source_access_policies", "policy_id"),
        "power_system_source_catalog.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_source_publication.schema.json"), "power_system_source_catalog", "publication_id"),
        "power_system_source_query_plans.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_source_query_plan.schema.json"), "power_system_source_query_plans", "plan_id"),
        "power_system_price_feeds.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_system_price_feed.schema.json"), "power_system_price_feeds", "feed_id"),
        "power_price_shape_rules.yaml": lambda data: _validate_keyed_mapping(data, _load_schema(schema_dir, "power_price_shape_rule.schema.json"), "power_price_shape_rules", "rule_id"),
